...
const DashboardPage = () => {
  ...
  const { firstName, lastName, loginTime , position} = storedUser;
  ...
  useEffect(() => {
    ...
    const now = new Date();
    const timeDifference = 9 * 3600000 - (now - loginDate); // 9 ชั่วโมง (ms)
            ...
            {firstName && loginTime ? (
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Box>
                  ...
                  <Typography>
                    <Typography component="span" sx={{ color: 'black', marginRight: '8px' }}>ตำแหน่ง :</Typography>
                    <Typography component="span" sx={{ color: 'black', fontWeight: 'bold' }}>{position}</Typography>
                  </Typography>
                  <Typography>
                  ...
                  <Typography>
                    ...
                    <Typography component="span" sx={{ fontWeight: 'bold', color: 'blue' }}>
                      {new Date(new Date(loginTime).getTime() + 9 * 3600000).toLocaleTimeString()}
                    </Typography>
                  </Typography>
